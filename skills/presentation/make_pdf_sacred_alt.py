...
# ─── Colors ──────────────────────────────────────────────────────────────────
DARK_BG     = HexColor('#88001B')
CARD_BG     = HexColor('#9B001F')
...
OUTPUT    = "/Users/oboton/Music/Docs/Святые_места_Бурятии_sangha_bg.pdf"
...
def title_slide(c, data):
    ...
    c.saveState()
    c.setFillColor(Color(0.53, 0.0, 0.1, alpha=0.6))
