...
# ─── Color Palette ───────────────────────────────────────────────────────────
DARK_BG      = RGBColor(0x88, 0x00, 0x1B)   # near-black deep blue
PANEL_BG     = RGBColor(0x16, 0x15, 0x22)   # dark panel
CARD_BG      = RGBColor(0x9B, 0x00, 0x1F)   # card / elevated surface
...
output = "/Users/oboton/Music/Docs/Святые_места_Бурятии_sangha_bg.pptx"
prs.save(output)
